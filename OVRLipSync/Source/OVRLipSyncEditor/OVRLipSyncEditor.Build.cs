...
public class OVRLipSyncEditor : ModuleRules
{
    public OVRLipSyncEditor(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDependencyModuleNames.AddRange( new string[] {
          ...
          "SlateCore",
          "Voice",
          "AudioExtensions",      // Added for UE 5.6 audio system
          "AudioMixer",           // Added for UE 5.6 audio system
          "SignalProcessing"      // Added for UE 5.6 audio processing
        });

        // Added private dependencies for UE 5.6 compatibility
